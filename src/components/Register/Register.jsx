        ...
        <div className="register-form-container">
          ...
          <form className="register-form">
            ...
            <input
              ...
              style={stateValue}
            />
            <label htmlFor="" style={stateValue3}>Company</label>
            <SelectCompany
            ...
            <label htmlFor="" className="role-label" style={stateValue3}>
              User role
            </label>
            <SelectRole
              options={roleOptions}
            ...
            <div className="small-text-right">
              <Link to="/login" className="small-text-anchor" style={stateValue3}>
